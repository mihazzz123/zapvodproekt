...
function chartRecalc(recArr) {
  var   maxItm = 0,
        precent = 0;
  for(var i = 0; i < recArr.length; i++) {
    if(maxItm < recArr[i]) { maxItm = recArr[i]; }
  }
  precent = maxItm / 100;
  for(var i = 0; i < recArr.length; i++) {
    recArr[i] = recArr[i] / precent;
  }
  return recArr;
}