$(document).ready(function () {
  ...
  function closeSidebar() {
    ...
    setTimeout(function () {
      $('.sidebar-item__name').animate({
        'width': '0'
      }, 100);
      $('.sidebar-item__block').animate({
        'padding-left': '33px'
      }, 100);
    }, 200);
    setTimeout(function () {
  ...
  $('.list').click(function () {
    ...
    if ($(this).hasClass('open')) {
      ...
      $(this).parents('.sidebar-item__block').find('.sidebar-list').animate({
        'height': '0',
        'margin': '0'
      }, 100);
    }
  ...
  $('.sort-date__btn').click(function () {
    if ($(this).hasClass('notf-sort__item_active')) {
      $('.sort-dropdown').removeClass('notf-sort__item_active');
      $(this).parents('.user-clndr').find('.sort-date').animate({
        'height': '270px'
      }, 300);
    } else {
      $(this).parents('.user-clndr').find('.sort-date').animate({
  ...
  var map = new mapboxgl.Map({
    container: 'map2',
    style: 'mapbox://styles/mihazzz123/ck6hvazzl0y5o1is5k37vbxrf',
